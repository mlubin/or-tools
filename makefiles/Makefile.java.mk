...
$(INSTALL_JAVA_NAME)$(ARCHIVE_EXT): java \
 $(SAMPLE_JAVA_FILES) \
 $(EXAMPLE_JAVA_FILES)
	$(COPY) $(JAVA_BUILD_PATH)$Sortools-java$Starget$S*.jar $(INSTALL_JAVA_NAME)
	$(COPY) $(JAVA_BUILD_PATH)$Sortools-$(JAVA_NATIVE_IDENTIFIER)$Starget$S*.jar $(INSTALL_JAVA_NAME)
